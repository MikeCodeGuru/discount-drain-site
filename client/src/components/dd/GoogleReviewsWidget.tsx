...
const AGGREGATE = {
  rating: 4.7,
  totalReviews: 131,
  googleUrl: "https://www.google.com/maps/place/Discount+Drain/@43.0078601,-81.188403,17z/",
};
...
const REVIEWS = [
  {
    ...
    rating: 5,
    date: "3 months ago",
    text: "I had Discount Drain come inspect my sewer line because I wanted a second opinion. The first company wanted to dig up and replace the pipe. Discount Drain told me honestly that the pipe was fine and relining was all I needed. They saved me from an unnecessary and expensive replacement. Professional, fair, and honest. Highly recommend!",
    avatar: "NH",
    avatarColor: "#4285f4",
  },
  {
    id: 2,
    name: "Isabelle Durdle",
    location: "London, ON",
    rating: 5,
    date: "3 months ago",
    text: "We called Discount Drain for a basement flooding issue. They came the same day to fix the problem. The communication and service were excellent. The price was very reasonable. Ryan was knowledgeable and efficient. It was a pleasure working with him and we would definitely call again.",
    avatar: "ID",
    avatarColor: "#34a853",
  },
  {
    ...
    rating: 5,
    date: "4 months ago",
    text: "These guys are pros. Honest, hardworking and on time. Special thanks to Jake, Telf and Kev for saving my basement. I am so grateful for all your hard work. You went above and beyond expectations.",
    avatar: "AC",
    avatarColor: "#ea4335",
  },
  {
    ...
    rating: 5,
    date: "5 months ago",
    text: "One of the best service companies we have dealt with. Very quick response time, which is very important when your toilets are not flushing! Friendly, professional and fair. We will be customers for life.",
    avatar: "JW",
    avatarColor: "#fbbc04",
  },
  {
    ...
    rating: 5,
    date: "7 months ago",
    text: "When we had a sewer backup in our basement Discount Drain came right away. Craig put a camera down the sewer line to show us the problem and immediately suggested a solution. The workers were professional, polite and friendly. The problem was resolved very quickly and efficiently. Highly recommend.",
    avatar: "RM",
    avatarColor: "#9c27b0",
  },
  {
    id: 6,
    name: "Nicholas Moorcroft",
    location: "London, ON",
    rating: 5,
    date: "7 months ago",
    text: "Aaron came out and cleared the drain in the basement and put a camera down to show what was going on. I had originally gone to another company but they only cleared 60 feet and wanted $600 for a partial job. Aaron cleared 100 feet and charged less. Very professional and informative. Would highly recommend Discount Drain.",
    avatar: "NM",
    avatarColor: "#00897b",
  },
];

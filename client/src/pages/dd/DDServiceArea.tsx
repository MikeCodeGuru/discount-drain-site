...
import { MapPin, Phone, Clock, CheckCircle2, ArrowRight, ChevronDown } from "lucide-react";
...
function ServiceAreaMapOverlayCard() {
    ...
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "8px" }}>
        ...
        <button
          ...
          className="sm:hidden"
          style={{ background: "none", border: "none", cursor: "pointer", padding: "2px", color: "#0080ff", display: "flex", alignItems: "center", flexShrink: 0 }}
        >
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "7px" }}>
          ...
          <a href="tel:5194518342" style={{ fontSize: "13px", fontWeight: 700, color: "#0080ff", textDecoration: "none", letterSpacing: "-0.01em" }}>
            519-451-8342
          </a>
        </div>
